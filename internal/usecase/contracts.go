...
type WishlistUseCase interface {
	...
	UpdateWishlist(ctx context.Context, id, userID uuid.UUID, input dto.UpdateWishlistInput) (entity.Wishlist, error)
	DeleteWishlist(ctx context.Context, id, userID uuid.UUID) error

	CreateItem(ctx context.Context, userID uuid.UUID, input dto.CreateWishlistItemInput) (entity.WishlistItem, error)
	...
	UpdateItem(ctx context.Context, id, userID uuid.UUID, input dto.UpdateWishlistItemInput) (entity.WishlistItem, error)
